...
const (
	FinalizerString = "finalizers.sns.services.k8s.aws/Subscription"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("subscriptions")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.Subscription{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.Subscription),
	}
}
